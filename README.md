 ...
 * [RapidPro v5.0.0](https://github.com/nyaruka/rapidpro/releases/tag/v5.0.0)
...
Major releases of RapidPro are made yearly on a set schedule. We target March 1st
...
Unstable releases have odd minor versions, that is `5.1` would indicate an unstable or *development*
...
first install `v5.0.14` before trying to install the next stable release `v5.2.0`.
