    ...
    class Activity(OrgObjPermsMixin, SmartReadView):
        ...
        def get(self, request, *args, **kwargs):
            ...
            if call:
                ...
                messages = Msg.all_messages.filter(contact=Contact.get_test_contact(self.request.user)).order_by('created_on')
    ...
    class Simulate(OrgObjPermsMixin, SmartReadView):
        ...
        def post(self, request, *args, **kwargs):
            ...
            if json_dict and json_dict.get('has_refresh', False):
                ...
                Msg.all_messages.filter(contact=test_contact).delete()
            ...
            messages = Msg.all_messages.filter(contact=test_contact).order_by('pk', 'created_on')
