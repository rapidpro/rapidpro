...
class FlowRunTest(TembaTest):
    ...
    def test_update_fields(self):
        ...
        self.assertEqual(run.fields_dict(), new_values)
        ...
        self.assertEqual(run.fields_dict(), {"0": "zero", "1": "one", "2": "two"})
...
class WebhookTest(TembaTest):
    ...
    def test_webhook(self):
        ...
        run1.refresh_from_db()
        self.assertEqual(run1.fields_dict(), {'text': "Get", 'blank': ""})
        ...
        run3.refresh_from_db()
        self.assertEqual(run3.fields_dict(), {'0': 'zero', '1': 'one', '2': 'two'})
        ...
        self.assertEqual(run4.fields_dict(), {str(n): 'x' for n in range(256)})
        ...
        self.assertEqual(run5.fields_dict(), {})
        ...
        self.assertEqual(run6.fields_dict(), {})
        ...
        self.assertEqual(run7.fields_dict(), {})
        ...
        self.assertEqual(run8.fields_dict(), {'text': "Valid", 'error': "400", 'message': "Missing field in request"})
