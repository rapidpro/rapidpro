# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-08-14 21:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session_type', models.CharField(choices=[('F', 'IVR'), ('U', 'USSD')], help_text='The type of session', max_length=1)),
                ('channel_session', models.OneToOneField(help_text='The channel session used for IVR and USSD type sessions', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='flow_session', to='channels.ChannelSession')),
