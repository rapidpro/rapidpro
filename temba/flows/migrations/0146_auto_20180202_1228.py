...
class Migration(migrations.Migration):
    ...
    dependencies = [("flows", "0145_update_path_trigger")]
    ...
    operations = [
        migrations.AlterField(
            ...
            field=temba.utils.models.JSONAsTextField(
                help_text="The JSON encoded actions for this action set", default=dict
            ),
        ),
        migrations.AlterField(
            ...
            name="config",
            field=temba.utils.models.JSONAsTextField(
                help_text="Any configuration options for this flow export", null=True, default=dict
            ),
        ),
        migrations.AlterField(
            model_name="flow",
        ...
        migrations.AlterField(
            ...
            name="path",
            field=temba.utils.models.JSONAsTextField(
                help_text="The path taken during this flow run in JSON format", null=True, default=list
            ),
        ),
        migrations.AlterField(
            model_name="flowrun",
            name="results",
            field=temba.utils.models.JSONAsTextField(
                help_text="The results collected during this flow run in JSON format", null=True, default=dict
            ),
        ),
        migrations.AlterField(
            ...
            name="extra",
            field=temba.utils.models.JSONAsTextField(
                help_text="Any extra parameters to pass to the flow start (json)", null=True, default=dict
            ),
        ),
        migrations.AlterField(
            model_name="ruleset",
        ...
        migrations.AlterField(
            ...
            name="rules",
            field=temba.utils.models.JSONAsTextField(
                help_text="The JSON encoded actions for this action set", default=list
            ),
        ),
    ]
