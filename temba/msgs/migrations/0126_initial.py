    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "purged_status",
                    models.CharField(
                        help_text="Used when broadcast is purged to record contact's message's state",
                        max_length=1,
                        null=True,
                    ),
                ),
                ("broadcast", models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to="msgs.Broadcast")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "high_priority",
                    models.NullBooleanField(help_text="Give this message higher priority than other messages"),
                ),
                (
                    "created_on",
                    models.DateTimeField(
