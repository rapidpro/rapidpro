    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "language_dict",
                    models.TextField(
                        help_text="The localized versions of the broadcast", null=True, verbose_name="Translations"
                    ),
                ),
                (
                    "base_language",
                    models.CharField(
                        blank=True,
                        help_text="The language used to send this to contacts without a language",
                        max_length=4,
                        null=True,
                    ),
                ),
                ...
                (
                    ...
                    models.DateTimeField(
                        auto_now_add=True, db_index=True, help_text="When this broadcast was created"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_finished",
                    models.BooleanField(default=False, help_text="Whether this export is finished running"),
                ),
                (
                    "uuid",
                    models.CharField(
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=0, help_text="Number of non-archived messages with this label"
                    ),
                ),
                (
                    "created_by",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "text",
                    models.TextField(
                        help_text="The actual message content that was sent", max_length=640, verbose_name="Text"
                    ),
                ),
                (
                    "priority",
                    models.IntegerField(
                        default=500, help_text="The priority for this message to be sent, higher is higher priority"
                    ),
                ),
                (
                    "created_on",
                ...
                (
                    "msg_type",
                    models.CharField(
                        choices=[("I", "Inbox Message"), ("F", "Flow Message"), ("V", "IVR Message")],
                ...
                (
                    ...
                    models.URLField(
                        blank=True,
                        help_text="The media associated with this message if any",
                        max_length=255,
                        null=True,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "org",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="system_labels", to="orgs.Org"
                    ),
                ),
            ],
        ),
        ...
        migrations.AddField(
            ...
            name="org",
            field=models.ForeignKey(
                help_text="The organization of the user.", on_delete=django.db.models.deletion.CASCADE, to="orgs.Org"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AlterIndexTogether(name="systemlabel", index_together=set([("org", "label_type")])),
