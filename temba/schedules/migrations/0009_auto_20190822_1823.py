...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='schedule',
            name='repeat_period',
            field=models.CharField(choices=[('O', 'Never'), ('D', 'Daily'), ('W', 'Weekly'), ('M', 'Monthly')], default='O', max_length=1),
            preserve_default=False,
        ),
        migrations.AlterField(
            model_name='schedule',
            name='status',
            field=models.CharField(choices=[('U', 'Unscheduled'), ('S', 'Scheduled')], default='U', max_length=1, null=True),
        ),
        migrations.AddField(
            model_name='schedule',
            name='org',
