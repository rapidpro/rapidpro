...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="%(class)s_exports", to="contacts.contactfield"
                    ),
                ),
                (
                    "with_groups",
                    models.ManyToManyField(
                        related_name="%(class)s_exports", to="contacts.contactgroup"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["org", "status"], name="tickets_tic_org_id_3bdc4d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="ticketcount",
            index=models.Index(
                fields=["org", "scope", "status"], name="tickets_tic_org_id_415b13_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="ticketcount",
