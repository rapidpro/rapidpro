...
BRANDING = {
    "rapidpro.io": {
        ...
        "flow_types": [
            ...
            "V",
            "S",
        ],  # see Flow.TYPE_MESSAGE, Flow.TYPE_VOICE, Flow.TYPE_SURVEY
...
CELERYBEAT_SCHEDULE = {
    ...
    "sync-old-seen-channels": {
        "task": "sync_old_seen_channels_task",
    ...
    "check-topup-expiration": {
        "task": "check_topup_expiration_task",
