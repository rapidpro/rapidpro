...
----------------------------------------------------------------------
CREATE OR REPLACE FUNCTION temba_broadcast_determine_system_label(_bcast msgs_broadcast) RETURNS CHAR(1) STABLE AS $$
BEGIN
  IF _bcast.schedule_id IS NOT NULL AND _bcast.is_active = TRUE THEN
    RETURN 'E';
  END IF;
