...
class Org(SmartModel):
    ...
    use_customize = models.BooleanField(default=False,
                                  help_text=_("Use customize output"))
    ...
    def import_app(self, data, user, site=None):
        ...
        if Flow.is_before_version(export_version, CURRENT_EXPORT_VERSION):
