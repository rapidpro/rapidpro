    ...
    class Menu(MenuMixin, InferOrgMixin, SmartTemplateView):
        ...
        def derive_menu(self):
            ...
            if org:
                ...
                other_org_items = [
                    self.create_menu_item(menu_id=other_org.id, name=other_org.name, avatar=other_org.name, event="temba-workspace-choosen")
                ...
                menu += [
                    self.create_menu_item(
                        ...
                        items=[
                            self.create_space(),
                            self.create_menu_item(menu_id="settings", name=org.name, avatar=org.name, event="temba-workspace-settings"),
                            self.create_divider(),
                            self.create_menu_item(
                                menu_id="logout",
                                name=_("Sign Out"),
