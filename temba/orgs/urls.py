...
urlpatterns += [
    ...
    # for spa
    url(r"^(?P<level_0>contacts|tickets|messages)/$", spa, name="spa"),
    url(r"^(?P<level_0>contacts|tickets|messages)/(?P<level_1>\w+)/$", spa, name="spa.level_1"),
    url(r"^(?P<level_0>contacts|tickets|messages)/(?P<level_1>\w+)/(?P<level_2>.+)/$", spa, name="spa.level_2"),
]
