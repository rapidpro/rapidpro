    ...
    def _create_archive_content(self, org, add):
        def create_archive(org, period, rollup=None):
            ...
            archive = Archive.objects.create(
                org=org,
                url=f"http://{settings.BUCKETS['archives']}.aws.com/{file}",
            ...
            self.mock_s3.put_object(settings.BUCKETS["archives"], file, body)
            return archive
        ...
        self.mock_s3.put_object(settings.BUCKETS["archives"], f"{org.id}/extra_file.json", io.StringIO("[]"))
