...
class Migration(migrations.Migration):
    ...
    dependencies = [migrations.swappable_dependency(settings.AUTH_USER_MODEL), ("locations", "0014_initial")]
            ...
            fields=[
                ...
                (
                    ...
                    temba.utils.models.JSONAsTextField(
                        default=dict, help_text="Webhook endpoint and configuration", null=True, verbose_name="Webhook"
                    ),
                ),
                (
                    "webhook_events",
