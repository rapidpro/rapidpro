# From: http://code.activestate.com/recipes/576515/
# Allows attaching to a remote process, do so by running this file with the PID of the python process as an argument.
# We enable this when the environment variable ATTACH is set.
...
def remote_debug(sig,frame): # pragma: no cover
...
def debug_process(pid): # pragma: no cover
