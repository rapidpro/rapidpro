            ...
            for c in CHANNELS:
                ...
                if channel.channel_type == "WAC":
                    TemplateTranslation.get_or_create(
                        ...
                        namespace="",
                        components=[
                            {"type": "header", "name": "header", "variables": {"1": 0}},
                            {
                                "type": "body",
                                "name": "body",
                            ...
                            {"type": "attachment", "name": "attachment", "variables": {"1": 5}},
                            {"type": "attachment", "name": "attachment", "variables": {"1": 6}},
                            {"type": "attachment", "name": "attachment", "variables": {"1": 7}},
                            {
                                "type": "button/url",
                                "name": "button.0",
                            ...
                            {"type": "button/quick_reply", "name": "button.2", "content": "Not Hungry"},
                        ],
                        variables=[
                            {"type": "image"},
                            {"type": "text"},
