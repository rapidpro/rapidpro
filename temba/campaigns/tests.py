...
class CampaignTest(TembaTest):
    ...
    def test_scheduling(self, mr_mocks):
        ...
        self.set_contact_field(self.farmer1, "planting_date", "05-10-2021 12:30:10", legacy_handle=True)
        ...
        self.assertEqual(2021, fire.scheduled.year)
        ...
        self.set_contact_field(self.farmer1, "planting_date", "06-10-2021 12:30:10", legacy_handle=True)
        ...
        self.set_contact_field(self.farmer1, "planting_date", "07-10-2021 12:30:10", legacy_handle=True)
