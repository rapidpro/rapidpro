...
from temba.channels.types.external.const import CONFIG_CONTENT_TYPE, CONFIG_SEND_BODY, CONFIG_SEND_METHOD
...
class TestChannel:
    ...
    def create(cls, org, user, courier_url, callback, country="EC", scheme="tel", address="123456", port=49999):
        ...
        config = {
            ...
            CONFIG_SEND_METHOD: "POST",
            CONFIG_CONTENT_TYPE: "application/json",
            CONFIG_SEND_BODY: '{"text": "{{text}}"}',
        }
