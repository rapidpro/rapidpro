...
class APITest(TembaTest):
    ...
    def test_api_serializer_fields(self):
        ...
        self.assertRaises(
            ValidationError, dict_field.to_internal_value, {123: "456"}
    ...
    def test_api_authentication(self):
        ...
        response = self.client.get(
            url, content_type="application/json", HTTP_X_FORWARDED_HTTPS="https", HTTP_AUTHORIZATION="Token 1234567890"
        )
        ...
        data = dict(
            ...
            steps=[
                dict(
                    node=color_ruleset.uuid,
                    arrived_on="2015-08-25T11:11:30.088Z",
                    rule=dict(uuid=orange_rule.uuid, value="orange", category="Orange", text="I like orange"),
                ),
                dict(
                    node=color_reply.uuid,
                    arrived_on="2015-08-25T11:13:30.088Z",
    ...
    def test_api_contacts(self):
        ...
        self.assertEqual(
            resp_json["results"][1]["fields"], {"real_name": "Andre", "registration_date": None, "state": "VA"}
        )
        ...
        self.assertEqual(
            ...
            {"real_name": None, "registration_date": "2014-12-31T03:04:00+02:00", "state": None},
        )
    ...
    def test_message_serialization(self):
        ...
        serializer = MsgCreateSerializer(
            org=self.org,
            user=self.admin,
            data={"urn": ["tel:+250964150000"], "contact": [self.joe.uuid], "text": "Hello1"},
        )
        ...
        serializer = MsgCreateSerializer(
            org=self.org,
            user=self.admin,
            data={"urn": ["tel:+250964150000"], "text": "Hello2", "channel": self.channel.id},
        )
        self.assertTrue(serializer.is_valid())
        ...
        serializer = MsgCreateSerializer(
            org=self.org,
            user=self.admin,
            data={"contact": [self.joe.uuid], "text": "Hello2", "channel": self.channel2.id},
        )
