...
from .serializers import (
    AdminBoundaryReadSerializer, ArchiveReadSerializer, BroadcastReadSerializer, BroadcastWriteSerializer,
    CampaignReadSerializer, CampaignWriteSerializer, CampaignEventReadSerializer, CampaignEventWriteSerializer,
    ChannelReadSerializer, ChannelEventReadSerializer, ContactReadSerializer, ContactWriteSerializer,
    ContactBulkActionSerializer, ContactFieldReadSerializer, ContactFieldWriteSerializer, ContactGroupReadSerializer,
    ContactGroupWriteSerializer, FlowReadSerializer, FlowRunReadSerializer, FlowStartReadSerializer,
    FlowStartWriteSerializer, LabelReadSerializer, LabelWriteSerializer, MsgReadSerializer, MsgBulkActionSerializer,
    ResthookReadSerializer, ResthookSubscriberReadSerializer, ResthookSubscriberWriteSerializer,
...
class ArchivesEndpoint(ListAPIMixin, BaseAPIView):
    ...
    def get_read_explorer(cls):
        return {
            ...
            'slug': 'archive-list',
            'params': [
                {'name': "archive_type", 'required': False, 'help': "An archive_type to filter by, like: run, message"},
