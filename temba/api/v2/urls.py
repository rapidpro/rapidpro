...
from .views import CampaignsEndpoint, CampaignEventsEndpoint, ContactsEndpoint, FlowDefinitionEndpoint
...
urlpatterns = [
    ...
    url(r'^/flow_definition$', FlowDefinitionEndpoint.as_view(), name='api.v2.flow_definition'),
