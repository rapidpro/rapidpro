...
class ConnectView(BaseConnectView):
    class Form(forms.Form):
        ...
        def clean(self):
            ...
            response = requests.get(url + "/apps/" + cleaned["app_id"] + "/versions/" + cleaned["version"] + "/intents",
                                    headers={LuisType.AUTH_HEADER: cleaned["primary_key"]})

            if response.status_code != 200:
                raise forms.ValidationError(_("Unable to get intents for your app, please check credentials and try again"))
