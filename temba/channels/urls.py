...
from .handlers import NexmoCallHandler, ViberHandler, TwimlAPIHandler, LineHandler
...
urlpatterns = [
    ...
    url(r'^handlers', include([
        ...
        url(r'^/nexmo/(?P<action>answer|event)/(?P<uuid>[a-z0-9\-]+)/$', NexmoCallHandler.as_view(), name='handlers.nexmo_call_handler'),
