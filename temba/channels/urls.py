...
from .handlers import ViberHandler, TwimlAPIHandler, LineHandler, FCMHandler
...
urlpatterns = [
    ...
    url(r'^handlers', include([
        ...
        url(r'^/fcm/(?P<action>register|receive)/(?P<uuid>[a-z0-9\-]+)/?$', FCMHandler.as_view(), name='handlers.fcm_handler'),
    ])),
