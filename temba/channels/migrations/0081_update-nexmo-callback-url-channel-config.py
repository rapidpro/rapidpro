...
class Migration(migrations.Migration):
    ...
    dependencies = [("channels", "0080_fix_sql_func")]
        ...
        if settings.IS_PROD:
            ...
            for channel in nexmo_channels:
                try:
                    ...
                    receive_url = (
                        "https://" + org.get_brand_domain() + reverse("courier.nx", args=[channel.uuid, "receive"])
                    )
                    client.update_nexmo_number(str(channel.country), channel.address, receive_url, app_id)
                except Exception:
                    import traceback
    ...
    operations = [migrations.RunPython(update_nexmo_channels_config)]
