...
from ...views import (
    VONAGE_SUPPORTED_COUNTRIES,
    VONAGE_SUPPORTED_COUNTRY_CODES,
...
class ClaimView(BaseClaimNumberMixin, SmartFormView):
    class Form(ClaimViewMixin.Form):
        country = forms.ChoiceField(
            choices=VONAGE_SUPPORTED_COUNTRIES, widget=SelectWidget(attrs={"searchable": True})
        )
    ...
    def is_valid_country(self, country_code):
        return country_code in VONAGE_SUPPORTED_COUNTRY_CODES

    def is_messaging_country(self, country):
        return country in [c[0] for c in VONAGE_SUPPORTED_COUNTRIES]
    ...
    def get_supported_countries_tuple(self):
        return VONAGE_SUPPORTED_COUNTRIES
