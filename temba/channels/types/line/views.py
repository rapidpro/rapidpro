...
class ClaimView(ClaimViewMixin, SmartFormView):
    class Form(ClaimViewMixin.Form):
        channel_id = forms.CharField(label=_("Channel ID"), required=True,
                                     help_text=_("The Channel ID of the LINE channel for the Bot"))
        name = forms.CharField(label=_("Name"), required=True,
                               help_text=_("The Name of the Bot"))
        ...
        def clean(self):
            ...
            existing = Channel.objects.filter(
                ...
                channel_type=self.channel_type.code, address=channel_id,
    ...
    def form_valid(self, form):
        ...
        self.object = Channel.create(org, self.request.user, None, self.channel_type,
                                     name=name, address=channel_id, config=config)
