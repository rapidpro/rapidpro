...
class ClaimView(ClaimViewMixin, SmartFormView):
    class Form(ClaimViewMixin.Form):
        ...
        fb_user_id = forms.CharField(required=True, help_text=_("The Faebook User ID of the admin that connected te channe"))
    ...
    def form_valid(self, form):
        ...
        app_id = settings.FACEBOOK_APPLICATION_ID ## 298392967836741
        app_secret = settings.FACEBOOK_APPLICATION_SECRET ## "ef2acad06e9f48195f8cc072f2a44064"

        # get user long lived access token
        url = "https://graph.facebook.com/oauth/access_token"
        params = {"grant_type": "fb_exchange_token", "client_id": app_id, "client_secret": app_secret, "fb_exchange_token": auth_token}
