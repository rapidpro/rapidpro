...
from .models import CHANNEL_EVENT, Alert, Channel, ChannelCount, ChannelEvent, ChannelLog, Connection, SyncEvent
...
class ChannelTest(TembaTest):
    ...
    def test_release_ivr_channel(self):
        ...
        self.assertNotEqual(call.status, Connection.INTERRUPTED)
        self.tel_channel.release()

        call.refresh_from_db()
        self.assertEqual(call.status, Connection.INTERRUPTED)
