        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "decimal_value",
                    models.DecimalField(
                        decimal_places=8, help_text="The decimal value of this value if any.", max_digits=36, null=True
                    ),
                ),
                (
                    "datetime_value",
                    models.DateTimeField(help_text="The datetime value of this value if any.", null=True),
                ),
                ...
                (
                    "contact",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="values", to="contacts.Contact"
                    ),
                ),
                (
                    "contact_field",
