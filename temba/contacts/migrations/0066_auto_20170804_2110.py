...
class Migration(migrations.Migration):
    ...
    dependencies = [("orgs", "0036_ensure_anon_user_exists"), ("contacts", "0065_backfill_urn_identity")]
    ...
    operations = [
        ...
        migrations.AlterUniqueTogether(name="contacturn", unique_together=set([("identity", "org"), ("urn", "org")])),
        migrations.RunSQL(
            "CREATE INDEX CONCURRENTLY contacts_contacturn_org_scheme_display "
