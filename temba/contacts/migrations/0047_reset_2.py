...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name="group",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="counts", to="contacts.ContactGroup"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="import_task",
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to="csv_imports.ImportTask"
            ),
        ),
        migrations.AddField(
            model_name="contactgroup",
        ...
        migrations.AlterUniqueTogether(name="contacturn", unique_together=set([("urn", "org")])),
    ]
