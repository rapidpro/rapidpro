...
from temba.utils import analytics, format_decimal, truncate, datetime_to_str, chunk_list, remove_control_characters
            ...
            with SegmentProfiler("output 500 contacts"):
                ...
                for contact_id in batch_ids:
                    ...
                    for col in range(len(fields)):
                        ...
                        if field_value:
                            field_value = unicode(remove_control_characters(field_value))
