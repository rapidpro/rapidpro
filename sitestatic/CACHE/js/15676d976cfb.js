function getCheckedIds(){var checkedIds=Array();var checks=$(".object-row.checked");for(var i=0;i<checks.length;i++){checkedIds.push(parseInt($(checks[i]).data("object-id")));}
